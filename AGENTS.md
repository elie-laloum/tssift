...
4. **Un corpus réel figé plus large** (T3) — `EVAL.md` § « Corpus limits » : trois mutations d'un seul dépôt. **Non commencé**, et B2 le remet en tête de liste devant tout ajout de fonctionnalité.
