...
Les codes hors table sortent au format natif. **Couvrir 10 codes bien vaut mieux que 60 à moitié** — la table en compte onze depuis le 2026-08-02, TS2740 y ayant été ajouté délibérément (voir ci-dessous) ; l'esprit de la règle est la couverture entière d'un petit ensemble, pas le nombre lui-même.
