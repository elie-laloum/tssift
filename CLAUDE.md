...
**P0, B0 et P1 sont livrés** (2026-07-27). `src/pipeline/` **existe et est complet** — dedupe, causalité, regroupement, budget ; `pipeline/enrich/` est ouvert depuis le 2026-08-01 et porte **onze codes**, 2307 · 2322 · 2739/2740/2741 compris depuis le 2026-08-02 — et **§5.2 est résolu en entier depuis le 2026-08-04**, 18047/18048 livrés et 18049 ajouté à la table sur décision. Depuis le 2026-07-28 le corpus de fixtures est à **24** — la cible de §8 lot B, dépassée depuis T0 de B1 — et la suite passe à **800 tests**. Détail à jour dans AGENTS.md § « État actuel » — ce paragraphe-ci n'en est qu'un raccourci et c'est l'autre qui fait foi.
